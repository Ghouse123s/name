...
class CreateBumaznieAboisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bumaznie_abois', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('dlina');
            $table->string('dizain');
            $table->string('imitazia_materiala');
            $table->string('still');
            $table->string('factura');
            $table->string('effect_pocritia');
            $table->string('stikofka_poloten');
    ...
    {
        Schema::dropIfExists('bumaznie_abois');
    }
}
